    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="help-container"):
            ...
            shortcuts = (
                ...
                "  [bold yellow]Tab[/bold yellow] / [bold yellow]Shift+Tab[/bold yellow] : Switch focus between Timeline, Breakdown, and Recommendations\n"
                "  [bold yellow]↑ / ↓[/bold yellow] or [bold yellow]j / k[/bold yellow]   : Navigate turns in timeline\n"
                "  [bold yellow]n / p[/bold yellow]           : Select next / previous AST content block in breakdown\n"
                "\n"
                "[bold #58a6ff]Cockpit & Integration Actions[/bold #58a6ff]\n"
