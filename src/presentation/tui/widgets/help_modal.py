    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="help-container"):
            ...
            shortcuts = (
                ...
                "  [bold yellow]u[/bold yellow]                 : Copy proxy unset environment command to clipboard\n"
                ...
                "\n"
                "[bold #e3b341]Network Proxy Requirement[/bold #e3b341]\n"
                "  Unproxied agent requests cannot be auto-detected (OS auto-routing requires root/VPN).\n"
                "  Launch your agent via [bold #58a6ff]ctxins run -- <agent>[/bold #58a6ff] or configure your shell with\n"
                "  [bold #58a6ff]eval $(ctxins env)[/bold #58a6ff]. Sessions appear dynamically when traffic arrives.\n"
                "\n"
                "[bold #58a6ff]Inspector Panes Overview[/bold #58a6ff]\n"
                "  [bold cyan][0] Sessions & Agents[/bold cyan]   : Active proxied sessions (AGY, Claude, OpenCode, Aider, etc.)\n"
